...
udhome := ../UD_Bambara
exportflag := $(localarch)/.export

$(exportflag): $(configfiles) $(corpvertfiles) $(corpprlfiles)
...
docker-local: exportfiles
	docker run -dit --name $(corpsite) -v $$(pwd)/$(localarch)/vert:/var/lib/manatee/vert -v $$(pwd)/$(localarch)/registry:/var/lib/manatee/registry -p 127.0.0.1:8088:8080 -e CORPLIST="$(corplist) corbama-ud" maslinych/noske-alt:2.142-alt1

pack-files: exportfiles
